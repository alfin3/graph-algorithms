...
Implementations of generic data structures and graph algorithms in straight C, providing potential space and speed advantages relative to the use of C++ abstractions in settings with limited memory resources.
