...
##
*Note that the purpose of the above evaluation was to measure parallelism with the number of processors. The evaluation was performed on a 13th Gen Intel(R) Core(TM) i7-13700HX Processor with Hyper-Threading on 8 of 16 physical cores. The number of “cores” included Intel’s Hyper-Threading Technology. Because the hash table design and implementation are extremely portable, the evaluation may be expanded to other hardware settings. The machine used for the above evaluation had a main memory of 16 GB.*
