...
\* unless the growth step did not lower the load factor below alpha because the maximum count of slots was reached, in which case alpha no longer bounds the load factor
