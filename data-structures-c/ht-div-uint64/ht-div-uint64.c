/**
   ...
   implementation is based on a division method for hashing into 2^64 - 1 
 ...
 */
static const uint64_t primes[23] = {1543, 3119, 6211,
				    12343, 23981, 48673,
				    88843, 186581, 377369,
				    ...
				    3221225479, 6442451311};
static const int num_uint32_primes = 22;
static const int num_primes = 23;
...
static void ht_grow(ht_div_uint64_t *ht){
  ...
  for (uint64_t i = 0; i < prev_ht_size; i++){
    ...
    while (*head != NULL){
      ...
      ht_div_uint64_insert(ht, (*head)->key, (*head)->elt);
      //NULL: if an element is multilayered, the pointer to it is deleted
