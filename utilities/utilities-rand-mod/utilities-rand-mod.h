/**
   utilities-rand-mod.h

   Declarations of accessible utility functions across the areas of 
   randomness, modular arithmetic, and binary representation. Includes
   assert statements for debugging purposes that can be turned off 
   with NDEBUG.
*/

#ifndef UTILITIES_RAND_MOD_H  
#define UTILITIES_RAND_MOD_H
